...
updateAmbulance(updatedAmbulance: any) {
  this.service.modifierAmbulance(updatedAmbulance).subscribe(
    res => {
      // Remplacer l'ambulance entière par l'objet mis à jour
      this.ambulance = res;
      console.log(res);
